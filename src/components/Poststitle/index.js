      ...
      <div className="container mx-auto px-6 my-20">
        <div className="md:flex md:items-center">
          <div className="w-full h-64 md:w-1/2 lg:h-96">
            <img className="h-full w-full rounded-md object-cover max-w-lg mx-auto" src={post.image} alt="Nike Air" />
          </div>
          <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
            <h3 className="text-gray-700 uppercase text-lg">{post.name}</h3>
            <span className="text-gray-500 mt-3">Gia: {post.price}</span>
            <hr className="my-3" />
            <span className="text-gray-500 mt-3">Mieu ta: {post.desc}</span>
            <hr className="my-3" />
            <div className="mt-2">
            ...
            <div className="flex items-center mt-6">
              <button className="px-8 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500" onClick={() => addtoCart(post)}>Order Now</button>
