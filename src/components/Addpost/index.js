...
const Addpost = ({ onAdd }) => {
    ...
    return (
        <div className="bg-fixed mb-1" style={{ backgroundImage: 'url("https://images.pexels.com/photos/1420709/pexels-photo-1420709.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940")' }}>
            <div className="flex items-center min-h-screen text-gray-800" >
            ...
            <div className=" w-1/2 mx-auto  ">
                <form action="" onSubmit={(e) => onHandleSubmit(e)}>
                    <input className="border-8" type="text" placeholder="Id" name="id" onChange={onHandleChange} />
                    <br />
                    ...
                    <br />
                    <input type="text" placeholder="Price   " name="price" onChange={onHandleChange} />
                    <br />
                    <button className="items-center">Add Product</button>
                </form>
            </div>
        </div>
    )
