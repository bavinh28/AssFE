...
const Homepost = ({ posts }) => {
    return (
        <>
        <div className="h-64 rounded-md overflow-hidden bg-cover bg-center my-10 mx-5" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1577655197620-704858b270ac?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1280&q=144")' }}>
                ...
                <div className="md:flex  my-10 mx-2">
            ...
            <div className="flex bg-gray-100 py-24 justify-center" style={{ backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDCFZS19iH0VZ2fKf1CXUS4gSA-jYZYn-iXw&usqp=CAU")' }}>
                <div className="p-12 text-center max-w-2xl">
                    <div className="md:text-3xl text-3xl font-bold">Hot hot</div>
                    <div className="text-xl font-normal mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.
    </div>
  ...
  cursor-pointer bg-green-600 rounded text-lg tr-mt  svelte-jqwywd"><Link to="girl">Go to store</Link></div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex bg-gray-100 py-24 justify-center" style={{ backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDCFZS19iH0VZ2fKf1CXUS4gSA-jYZYn-iXw&usqp=CAU")' }}>
                <div className="p-12 text-center max-w-2xl">
                    <div className="md:text-3xl text-3xl font-bold">Best sell</div>
                    <div className="text-xl font-normal mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.
    </div>
                    <div className="mt-6 flex justify-center h-12 relative">
                        <div className="flex shadow-md font-medium absolute py-2 px-4 text-green-100
  cursor-pointer bg-green-600 rounded text-lg tr-mt  svelte-jqwywd"><Link to="/men">Go to store</Link></div>
                    </div>
                </div>
            </div>
            <section id="main">
