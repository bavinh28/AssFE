...
const Home = () => {
    return (
        <section className="bg-no-repeat bg-fixed" style={{ backgroundImage: 'url("https://images.pexels.com/photos/2775196/pexels-photo-2775196.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")' }}>
